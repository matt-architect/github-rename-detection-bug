...
namespace Demo.Fhir.Order.Application.Mapping.Profiles.USCDI.V1
{
    ...
    /// </summary>
    public class MapRedactedOrderUSCDIV1 : MapRedactedOrderUSCDI
    {
        /// <summary>
        /// Mapping expression
        /// </summary>
        ...
        /// 
        /// </summary>
        public MapRedactedOrderUSCDIV1(IInterfaceTranslation interfaceTranslation, ICodeSystemLookup codeSysLookup, ISecurityLabelHelper securityLabelHelper, IWebApiHelper webAPIHelper, IDataSource dataSource) :
