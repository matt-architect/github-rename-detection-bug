...
namespace Demo.Fhir.Order.Application.Mapping.Profiles.USCDI.V1
{
    ...
    /// <summary>
    /// USCDI v1-specific implementation for mapping redacted order data.
    /// </summary>
    public class MapRedactedOrderUSCDIV1 : MapRedactedOrderUSCDI
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MapRedactedOrderUSCDIV1"/> class.
        /// </summary>
        ...
        public MapRedactedOrderUSCDIV1(
